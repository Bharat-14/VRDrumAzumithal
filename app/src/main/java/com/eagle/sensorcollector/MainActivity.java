...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                listConfigs.add("All 2");
                listConfigs.add("Accelerometer");
                listConfigs.add("magneometer");
    ...
    private void startSensor(){
        ...
        if((configSelected == 0) || (configSelected == 1)) sensorManager.registerListener(sensorThread, sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER), SAMPLING_RATE_LS);
        if((configSelected == 0) || (configSelected == 2)) sensorManager.registerListener(sensorThread, sensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD), SAMPLING_RATE_LS);
    ...
    private void stopSensor(){
        if((configSelected == 0) || (configSelected == 1)) sensorManager.unregisterListener(sensorThread, sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER));
        if((configSelected == 0) || (configSelected == 2)) sensorManager.unregisterListener(sensorThread, sensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD));
